 ...
 * @returns {Object} The textarea ref and adjust height function
 */
...
/**
 * Animated placeholder component that switches between search and ask text
 * @param {Object} props
 * @param {boolean} props.showSearch - Whether to show search text or ask text
 */
...
export default function AiInput() {
  ...
  /**
   * Handle closing/removing the image preview
